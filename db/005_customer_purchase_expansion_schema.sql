...
CROSS JOIN (
  VALUES
    ...
    ('vehicle', '5座轿车', true, 10, '五座轿车用车费用项目'),
    ('vehicle', '7座商务车', true, 20, '七座商务车用车费用项目'),
    ('vehicle', '19座中巴', true, 30, '十九座中巴用车费用项目'),
    ('vehicle', '33座大巴', true, 40, '三十三座大巴用车费用项目'),
    ('vehicle', '45座大巴', true, 50, '四十五座大巴用车费用项目'),
    ...
    ('extra_fee', '加景点', true, 10, '临时增加景点产生的附加费用项目'),
    ('extra_fee', '升级住宿', true, 20, '临时升级酒店或房型产生的附加费用项目'),
    ('extra_fee', '加餐', true, 30, '临时增加或升级用餐产生的附加费用项目'),
    ('extra_fee', '延住', true, 40, '团队延长住宿产生的附加费用项目'),
    ('extra_fee', '超公里费', true, 50, '车辆超出约定公里数产生的附加费用项目'),
    ('extra_fee', '超时费', true, 60, '车辆或服务超出约定时间产生的附加费用项目'),
