...
const CustomerCreditRulePage = () => import('#/views/customer/credit-rule/index.vue');
...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { name: 'CustomerCreditRule', path: '/customer/credit-rules', component: CustomerCreditRulePage, meta: { hideInMenu: true, title: '客户授信规则' } },
