...
class CustomerCategoryControllerMappingTest {

    @Test
    void customerCategoryShouldOnlyExposeGetAndPostMappings() {
        Set<RequestMethod> methods = Arrays.stream(CustomerCategoryController.class.getDeclaredMethods())
                ...
                .flatMap(CustomerCategoryControllerMappingTest::mappingMethods)
