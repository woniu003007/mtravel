...
public record SupplierResponse(
        ...
        String basicInfo, String contactName, String contactPhone, String faxNumber, String officeAddress, String agreementName, Integer rating,
        String status, String remark, String createdBy, OffsetDateTime createdAt, OffsetDateTime updatedAt,
        Integer boundResourceCount, String defaultResourceNames, String priceSummary
) {
    ...
    public static SupplierResponse fromEntity(SupplierEntity entity, String buyerName) {
        return fromEntity(entity, buyerName, 0, null, null);
    }

    public static SupplierResponse fromEntity(
            SupplierEntity entity,
            String buyerName,
            Integer boundResourceCount,
            String defaultResourceNames,
            String priceSummary
    ) {
        return new SupplierResponse(
                ...
                entity.getBasicInfo(), entity.getContactName(), entity.getContactPhone(), entity.getFaxNumber(), entity.getOfficeAddress(), entity.getAgreementName(), entity.getRating(),
                entity.getStatus(), entity.getRemark(), entity.getCreatedBy(), entity.getCreatedAt(), entity.getUpdatedAt(),
                boundResourceCount == null ? 0 : boundResourceCount,
